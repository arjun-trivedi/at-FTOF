    ...
    for (i=0; i<npoints; i++) {
     ...
     adc_num << "point_" << i+1;      
      ...
      gtl->Delete();      
       ...
       hist_2_3_4_cont[i]->Fit("gaus","WWQ0");
      ...
      hist_1_2_3_cont[i]->Fit("gaus","WWQ0");
      ...
      hist_3_4_5_cont[i]->Fit("gaus","WWQ0");
      ...
      hist_4_5_6_cont[i]->Fit("gaus","WWQ0");
      ...
      hist_1_3_5_cont[i]->Fit("gaus","WWQ0");
      ...
      gtl->Delete();  
       ...
       hist_2_4_6_cont[i]->Fit("gaus","WWQ0");
...
resol_2_4_6_cont_corr->GetYaxis()->SetTitleOffset(1.3);              
   ...
   for (i=0; i<npoints; i++) {
       ...
       hist_2_3_4_cont_corr[i]->Fit("gaus","WWQ0");
      ...
      hist_1_2_3_cont_corr[i]->Fit("gaus","WWQ0");
      ...
      hist_3_4_5_cont_corr[i]->Fit("gaus","WWQ0");
      ...
      hist_4_5_6_cont_corr[i]->Fit("gaus","WWQ0");
      ...
      hist_1_3_5_cont_corr[i]->Fit("gaus","WWQ0");
      ...
      gtl->Delete();  
       ...
       hist_2_4_6_cont_corr[i]->Fit("gaus","WWQ0");
